<template>
    <div class="categories">
        ...
        <div class="category-content">
            <router-link :class="'categoryLink' + index" :title="item.label" class="category-link" :to="'/main/archive/class/' + item.value" v-for="(item, index) in articleClassList" :key="index">
